...
import {
    ...
    CreateCartResponse,
    DeleteItemInCartBody,
    DeleteItemInCartResponse,
    GetCartResponse,
    UpdateItemInCartBody,
...
export const cartService = {
    ...
    addItemInCart: async (data: AddItemInCartBody) => {
        return request
            .post<AddItemInCartBody, AxiosResponse<AddItemInCartResponse>>('/cart/add', data)
            .then((res) => res.data);
    },
    updateItemInCart: async (data: UpdateItemInCartBody) => {
        return request
            .post<UpdateItemInCartBody, AxiosResponse<UpdateItemInCartResponse>>('/cart/update', data)
            .then((res) => res.data);
    },
    deleteItemInCart: async (data: DeleteItemInCartBody) => {
        return request
            .post<DeleteItemInCartBody, AxiosResponse<DeleteItemInCartResponse>>('/cart/delete', data)
            .then((res) => res.data);
    },
};
